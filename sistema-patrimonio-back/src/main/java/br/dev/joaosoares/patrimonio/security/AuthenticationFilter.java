package br.dev.joaosoares.patrimonio.security;
...
import br.dev.joaosoares.patrimonio.config.SecurityConfig;
...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private TokenService jwtTokenService; // Service que definimos anteriormente
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (checkIfEndpointIsNotPublic(request)) {
            ...
            if (token != null) {
                ...
                Usuario user = userRepository.findByUserEmail(subject).get(); // Busca o usuário pelo email (que é o assunto do token)
